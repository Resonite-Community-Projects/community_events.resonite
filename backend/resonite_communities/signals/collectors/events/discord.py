    ...
    def collect(self):
        ...
        for community in self.communities:
            ...
            for local_event in self.model.find(
                ...
                # Check on events in the database to change the one in progress as READY if this time for them
                ...
                # TODO: Add a control to set event who have the same title and happen at the same time to choose only one
                # TODO: Set the image on both of them
